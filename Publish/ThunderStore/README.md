# MeasureTwice
Adds an adjustable length piece that self-destructs after a set period of time to use for precise spacing.
...
## Features
- New Custom Ruler piece that costs nothing and has an adjustable thing.
- Configureable time before self-destructing.
- Configurable keys for adjusting length of the Custom Ruler.
...
| Github Repository: | <img height="18" src="https://github.githubassets.com/favicons/favicon-dark.svg"></img><a href="https://github.com/searica/MeasureTwice"> MeasureTwice</a> |
|-----------|---------------|
...
- [EitrExtended](https://thunderstore.io/c/valheim/p/Searica/EitrExtended/)
